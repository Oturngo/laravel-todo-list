            ...
            @if (isset($todo))
              ...
              <form action="/todo/{{ $todo->id }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="todo-title" id="todo-title" value="{{ $todo->title}}" maxlength="100"  class="form-group" required>
                </div>

                {{-- Todo description --}}
                  <div class="form-group">
                  <label for="todo-description" class="control-label">Description</label>
                  <input type="text" name="todo-description" id="todo-description" value="{{ $todo->description}}" rows="3" maxlength="5000"  class="form-group" required>
                </div>

                {{-- Todo status --}}
                <div class="form-group">
                  <label for="todo-status" class="control-label">Status</label>
                  <select name="todo-status" id="todo-status" class="form-control" required>
